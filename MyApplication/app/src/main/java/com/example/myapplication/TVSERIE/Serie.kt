...
@Composable
fun ScreenSerie(windowClass: WindowSizeClass,homeViewModel: HomeViewModel,navController: NavController) {

    var text by remember { mutableStateOf("") }
    var active by remember { mutableStateOf(false) }
    val series by homeViewModel.TV.collectAsState()
    ...
    Scaffold {
        ...
        SearchBar(query = text, onQueryChange = { text = it },
            ...
            onSearch = {
                ...
                active = false
                homeViewModel.searchSeries(text)
